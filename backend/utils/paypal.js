...
async function getPayPalAccessToken() {
  try {
    ...
    console.error(`Error while getting PayPal access token: ${err}`);
  }
}
...
export async function checkIfNewTransaction(orderModel, paypalTransactionId) {
  try {
    ...
    console.error(`Error while checking new transaction: ${err}`);
  }
}
...
export async function verifyPayPalPayment(paypalTransactionId) {
  try {
    ...
    console.error(`Error while verifying PayPal payment: ${err}`);
  }
}
